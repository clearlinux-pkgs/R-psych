...
Version  : 2.2.5
Release  : 62
URL      : https://cran.r-project.org/src/contrib/psych_2.2.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/psych_2.2.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652204116
