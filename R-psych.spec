...
Version  : 2.1.9
Release  : 52
URL      : https://cran.r-project.org/src/contrib/psych_2.1.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/psych_2.1.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632322681
