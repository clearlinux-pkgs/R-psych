...
Version  : 1.8.10
Release  : 19
URL      : https://cran.r-project.org/src/contrib/psych_1.8.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/psych_1.8.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541010994
