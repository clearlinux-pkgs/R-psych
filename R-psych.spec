...
Version  : 2.1.3
Release  : 44
URL      : https://cran.r-project.org/src/contrib/psych_2.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/psych_2.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617035644
