...
Version  : 2.0.7
Release  : 38
URL      : https://cran.r-project.org/src/contrib/psych_2.0.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/psych_2.0.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595867231
